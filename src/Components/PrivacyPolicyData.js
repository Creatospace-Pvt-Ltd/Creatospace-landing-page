    ...
    <>
      <div data-custom-class="body">
            ...
            <strong>
              <span style={{ fontSize: "15px" }}>
                <span data-custom-class="subtitle">
                  Last updated <bdt className="question">August 31, 2022</bdt>
                </span>
              </span>
            </strong>
          </span>
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
              <span data-custom-class="body_text">
                ...
                <bdt className="question">Creatospace Pvt. Ltd.</bdt>
              ...
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">
                    <a
                      href="https://creatospace.com"
                      target="_blank"
                      data-custom-class="link"
                    >
                      https://creatospace.com
                    </a>
                  </bdt>
                  <span style={{ fontSize: "15px" }}>
                    <span style={{ color: "rgb(89, 89, 89)" }}>
          ...
          <span style={{ fontSize: "15px" }}>
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span data-custom-class="body_text">
                ...
                <bdt className="question">saswat@creatospace.com</bdt>.
              </span>
            </span>
          </span>
        </div>
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: "15px" }}>
            <span data-custom-class="body_text">
              ...
              <bdt className="block-component"></bdt>categories of{" "}
              <bdt className="statement-end-if-in-editor" />
              third parties. Click
            </span>
          </span>
        ...
        <div style={{ lineHeight: "1.5" }}>
          ...
          <a
            data-custom-class="link"
            href="https://app.termly.io/notify/34e02c2b-fe22-4c5f-9198-2ac3a01d4030"
          ...
          <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                data (or user <bdt className="block-component" />
                behavior
                      ...
                      <span style={{ color: "rgb(89, 89, 89)" }}>
                        <span style={{ color: "rgb(89, 89, 89)" }}>
                          <span data-custom-class="body_text">
                            ...
                            your information when necessary to request feedback
                                    ...
                                    <em>
                                      <span style={{ fontSize: "15px" }}>
                                        <span data-custom-class="body_text">
                                          ...
                                          we believe it is necessary and we have
                                  ...
                                  <div style={{ lineHeight: "1.5" }}>
                                    <span style={{ fontSize: "15px" }}>
                                      <span data-custom-class="body_text">
                                        ...
                                        information. This means that they cannot
                                        do anything with your personal
                                        information unless we have instructed
                                        them to do it. They will also not share
                                        your personal information with any
                                        <bdt className="block-component" />
                                        organization
                                        <bdt className="statement-end-if-in-editor" />
                                        apart from us. They also commit to
                                        protect the data they hold on our behalf
                                        and to retain it for the period we
                                        instruct.{" "}
                                        <bdt className="statement-end-if-in-editor" />
                                        The
                                        <bdt className="block-component" />
                                  ...
                                  <div style={{ lineHeight: "1.5" }}>
                                    ...
                                    <ul>
                                      <li style={{ lineHeight: "1.5" }}>
                                        <span style={{ fontSize: "15px" }}>
                                          <span data-custom-class="body_text">
                                            <strong>Affiliates.</strong>We may
                                      ...
                                      <li style={{ lineHeight: "1.5" }}>
                                        <span style={{ fontSize: "15px" }}>
                                          <span data-custom-class="body_text">
                                            ...
                                            available outside the Services in
                                            perpetuity.
                                            <bdt className="block-component" />{" "}
                                            If you interact with other users of
                                            our Services and register for our
                                            Services through a social network
                                            (such as Facebook), your contacts on
                                            ...
                                            within our Services, and view your
                                            profile.
                                            <bdt className="statement-end-if-in-editor"></bdt>
                                          </span>
                                        </span>
                                      ...
                                      <li style={{ lineHeight: "1.5" }}>
                                        <span data-custom-class="body_text">
                                          <span style={{ fontSize: "15px" }}>
                                            ...
                                            your geographic area or demographic
                                            information. When you click on an
                                            offer wall, you will be brought to
                                            an external website belonging to
                                            other persons and will leave our
                                            application(s). A unique identifier,
                                            such as your user ID, will be shared
                                            with the offer wall provider in
                                            order to prevent fraud and properly
                                      ...
                                      <span style={{ fontSize: "15px" }}>
                                        <span data-custom-class="body_text">
                                          ...
                                          <em>
                                            ...
                                            share with third parties that we may
                                            link to or who advertise on our
                                    ...
                                    <div style={{ lineHeight: "1.5" }}>
                                      <span style={{ fontSize: "15px" }}>
                                        <span data-custom-class="body_text">
                                          ...
                                          are not affiliated with us and which
                                          may link to other websites, services,
                                          or applications. Accordingly, we do
                                          not make any guarantee regarding any
                                          such third parties, and we will not be
                                          liable for any loss or damage caused
                                          by the use of such third-party
                                          ...
                                          endorsement by us. We cannot guarantee
                                          the safety and privacy of data you
                                          provide to any third parties. Any data
                                          collected by third parties is not
                                          covered by this privacy notice. We are
                                          not responsible for the content or
                                          privacy and security practices and
                                          policies of any third parties,
                                          including other websites, services, or
                                          applications that may be linked to or
                                          from the Services. You should review
                                          the policies of such third parties and
                                          contact them directly to respond to
                                          your questions.
                                        </span>
                                      </span>
                                      <bdt className="statement-end-if-in-editor">
                                      ...
                                      >
                                        ...
                                        >
                                          <span data-custom-class="body_text">
                                            ...
                                            Twitter logins). Where you choose to
                                            do this, we will receive certain
                                      ...
                                      >
                                        ...
                                        >
                                          <span data-custom-class="body_text">
                                            ...
                                            or services of our Services. To opt
                                      ...
                                      >
                                        ...
                                        >
                                          <span data-custom-class="body_text">
                                            ...
                                            publicly displayed on the Services,
                                      ...
                                      >
                                        ...
                                        >
                                          <span data-custom-class="body_text">
                                            ...
                                            collects and shares your personal
                                            information through:
                                            <span
                                              style={{
                                                color: "rgb(89, 89, 89)",
                                          ...
                                          >
                                            ...
                                            >
                                              <span data-custom-class="body_text">
                                                ...
                                                authorized
                                                <bdt className="statement-end-if-in-editor"></bdt>{" "}
                                                agent to exercise your right to
                                          ...
                                          >
                                            ...
                                            >
                                              <span data-custom-class="body_text">
                                                ...
                                                provider is a for-profit entity
